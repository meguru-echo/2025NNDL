...
class RNN_model(nn.Module):
    ...
    def forward(self,sentence,is_test = False):
        ...
        h_0 = torch.zeros(2, batch_input.size(0), self.lstm_dim, device=batch_input.device)
        c_0 = torch.zeros(2, batch_input.size(0), self.lstm_dim, device=batch_input.device)
